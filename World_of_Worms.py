...
icon = pygame.image.load("img/worm_icon.PNG")
food_image = pygame.image.load("img/food1.PNG")
food_image = pygame.transform.smoothscale(food_image, (25, 25))
bomb_image = pygame.image.load("img/bomb_worm.PNG")
...
instructions_img = pygame.transform.smoothscale(instructions_img, (dis_width, dis_height))

btn_lvl1 = pygame.image.load("img/level1_button.PNG")
btn_lvl1 = pygame.transform.smoothscale(btn_lvl1, (dis_width/2, dis_height/3))
btn_lvl2 = pygame.image.load("img/level2_button.PNG")
btn_lvl2 = pygame.transform.smoothscale(btn_lvl2, (dis_width/2, dis_height/3))
btn_lvl3 = pygame.image.load("img/level3_button.PNG")
